...
out = cv2.VideoWriter('output.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 16, (frame_width,frame_height))
...
while True:
    ...
    out.write(frame)    ## Write the frame into the file 'output.avi'. Includes green detection rectangles.
